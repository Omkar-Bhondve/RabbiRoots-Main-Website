  ...
  if (!item && !loading) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-gray-50">
        ...
        <Link to="/" className="px-6 py-3 bg-green-600 text-white rounded-xl font-semibold hover:bg-green-700 transition-colors">
          Back to Home
        </Link>
      </div>
    );
    ...
    <div className="min-h-screen bg-[#F8F9FA] pb-20">
      ...
      <div className="bg-white border-b border-gray-100 sticky top-[68px] z-40 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-14 flex items-center text-sm text-gray-500">
            ...
            <span className="hover:text-green-600 transition-colors cursor-pointer">Categories</span>
            <ChevronRight size={14} className="mx-2 text-gray-400" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            {item.featureImages && item.featureImages.length > 0 && (
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
                    {item.featureImages.slice(0, 4).map((feat, i) => (
                        <div key={i} className="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm flex flex-col items-center text-center hover:shadow-md transition-shadow">
                            <img src={feat.image} alt="" className="w-16 h-16 object-contain mb-3" />
            ...
            <div className="mt-8 bg-white p-6 rounded-3xl border border-gray-100 shadow-sm">
                ...
                <div className="text-sm text-gray-600 leading-relaxed space-y-3">
                    <p>{item.description || item.short || "Experience the best quality with our premium selection. Carefully sourced and packed with care."}</p>
            ...
            <div className="bg-white rounded-3xl p-6 lg:p-8 shadow-sm border border-gray-100 sticky top-24">
                ...
                <div className="mb-6">
                    ...
                    <div className="flex items-center gap-4 mt-3">
                        <div className="flex items-center bg-green-50 px-2 py-1 rounded-lg gap-1 border border-green-100">
                            ...
                            <span className="text-xs font-bold text-green-800 ml-1">4.8</span>
                        </div>
                        <span className="text-sm text-gray-500 font-medium">235 Reviews</span>
                    </div>
                </div>
                ...
                <div className="flex items-end justify-between mb-8">
                    <div>
                        ...
                        <div className="flex items-baseline gap-3">
                            <span className="text-4xl font-extrabold text-gray-900">{formatPrice(item.price)}</span>
                            {item.originalPrice && (
                                <span className="text-lg text-gray-400 line-through decoration-2">{formatPrice(item.originalPrice)}</span>
                            )}
                        </div>
                    ...
                    <div className="flex items-center justify-between bg-gray-50 p-2 rounded-2xl border border-gray-100">
                        ...
                        <div className="text-right pr-4">
                            ...
                            <p className="font-bold text-gray-900">
                                {typeof item.price === 'number' ? `₹${item.price * quantity}` : item.price}
                            </p>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-3 gap-4 py-6 border-t border-gray-100">
                    <div className="flex flex-col items-center text-center gap-2">
                        ...
                        <span className="text-xs font-semibold text-gray-700">Superfast Delivery</span>
                    </div>
                    <div className="flex flex-col items-center text-center gap-2">
        ...
        <div className="mt-20">
            <div className="flex items-center justify-between mb-8">
                ...
                <Link to="/" className="text-green-600 font-semibold hover:text-green-700 flex items-center gap-1">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
                {related.map((p) => (
                    ...
                    >
                        ...
                        <h3 className="font-semibold text-gray-900 text-sm mb-1 line-clamp-2 min-h-[40px]">{p.name}</h3>
