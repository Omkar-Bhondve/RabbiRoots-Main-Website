...
function MouthFreshner() {
  ...
  const allProducts = createUnifiedProducts().filter(product => product.category === 'ProductOne' || product.category === 'ProductTwo');

  return (
    <div className="w-full py-6 px-22 max-lg:px-8">
      <h1 className="font-semibold text-2xl py-4">Mouth fresheners</h1>
